package com.learnwithme.xyzreader.data.local;

import android.database.sqlite.SQLiteDatabase;

import com.learnwithme.xyzreader.data.local.ArticlesDatabase.Table;
        ...
        return Completable.create(e -> {
            ...
            try {
                ...
                for (Article article : articles) {
                    ...
                    if (result < 0) {
                        e.onError(new Throwable("Error inserting a row."));
                    }
                }
